...
module.exports = {
    ...
    requestUrl: function(url, callback, options){
        ...
        request(opts, function (err, response, body) {
            if (err) {
                ...
                var errorCatchMessage = options.errorCatchMessage;
                if (errorCatchMessage && body == errorCatchMessage){
                    return callback(new Error(errorCatchMessage), null);
                }
    ...
    convertToFahrenheit: function(c){
        return (f * (9/5)) + 32;
    }
};