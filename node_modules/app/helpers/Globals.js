...
module.exports = {
    ...
    INTERVAL : 30,
    WEATHER_UPDATE_TIME : "4:00PM",
    weatherUpdateHour : function(){
        var hour = parseInt(this.WEATHER_UPDATE_TIME.split(":")[0]);
        if (this.WEATHER_UPDATE_TIME.toUpperCase().indexOf("PM") != -1 && hour != 12 ){
            hour += 12;
        }
        return hour;
    },
