...
customSchema.statics.sendWeatherPushNotifications = function(weatherAtZipcode, users){
    ...
    weatherAtZipcode.populate("_current_forecast", function(err, _weather){
       if (err){
           ...
           var typeOfWeatherDesc = weatherAtZipcode.typeOfWeatherDescription();
           var rainingDesc =  weatherAtZipcode.precipDescription();

           var message = "Hey! %s Today's high/low will be %d°/%d°. %s";
           var tempArgs = [typeOfWeatherDesc, forecast.maxtemp_f, forecast.mintemp_f, rainingDesc];
