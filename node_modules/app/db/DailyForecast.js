...
customSchema.statics.forecastForLocation = function(lat, lon, callback){
    var url = "https://api.darksky.net/forecast/" + process.env.DARKSKY_API_KEY + "/" + lat + "," + lon;
    ...
    Globals.requestUrl(url, function(err, json){
        ...
        if (err){
            ...
            var maxIndex = 24 - Globals.weatherUpdateHour();
            ...
            for (var i = 0; i < maxIndex; i++){
                ...
                var currHour = i + Globals.weatherUpdateHour();
